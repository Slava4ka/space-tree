...
export const CAMERA_BASE_DISTANCE = Math.sqrt(800 * 800 + 1000 * 1000); // Базовое расстояние камеры (предвычислено для оптимизации)
...
export const MOBILE_TEXT_OFFSET_Y = 438;            // Вертикальное смещение текста над узлом для мобильных устройств (в пикселях)
export const MOBILE_TEXT_OFFSET_X = 150;             // Горизонтальное смещение текста влево для мобильных устройств (в пикселях)
...
export const LEVEL_1_COLOR = 0x4a90e2;             // Голубой для уровня 1 (дочерние узлы)
...
// ==================== Mobile Text константы ====================
export const MOBILE_MIN_FONT_SIZE = 18;            // Минимальный размер шрифта для мобильных устройств
export const DESKTOP_MIN_FONT_SIZE = 32;           // Минимальный размер шрифта для десктопов
export const MOBILE_FONT_SIZE_REDUCTION_FACTOR = 0.85; // Коэффициент уменьшения шрифта для мобильных (более агрессивный)
export const DESKTOP_FONT_SIZE_REDUCTION_FACTOR = 0.9; // Коэффициент уменьшения шрифта для десктопов
...
export const ROOT_WORD_LABEL_PLACEMENT_RADIUS = 600; // Радиус размещения надписей вокруг рутового узла
